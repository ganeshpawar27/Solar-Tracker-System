...
/**
 * Bean definitions for {@link RequestRepository}.
 */
@Generated
public class RequestRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'requestRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRequestRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'requestRepository'.
   */
  public static BeanDefinition getRequestRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RequestRepository.class, InstallationRequest.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.solartrack.repository.RequestRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.RequestRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.solartrack.repository.RequestRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getRequestRepositoryInstanceSupplier();
